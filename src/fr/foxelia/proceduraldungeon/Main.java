...
public class Main extends JavaPlugin {
	...
	public void onEnable() {
		...
		getServer().getPluginManager().registerEvents(new fr.foxelia.proceduraldungeon.gameplay.DungeonListener(), this);
	}
	
	@Override
	public void onDisable() {
		fr.foxelia.proceduraldungeon.gameplay.DungeonInstanceManager.getInstance().cleanupAll();
